...
export const EvilBoyCircle = (props) => {
    const groupBoy = useRef()
    const { nodes, materials } = useGLTF('/assets/models/avatars/hellboy.glb')
    const radius = 2.1
    const speed = 1.5
    ...
    useFrame((state,delta)=>{
        ...
        groupBoy.current.rotation.y = -angle
    })
...
useGLTF.preload('/assets/models/avatars/hellboy.glb/hellboy.glb')